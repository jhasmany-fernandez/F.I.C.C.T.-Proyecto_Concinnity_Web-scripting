                    ...
                    <div class="card-header">
                        <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                ...
                                <div style="display:table; text-align: center;">
                                    <h4 class="text-primary" style="display:table-cell; vertical-align:middle;">Creando Nueva Nota de Venta</h4>
                                </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="form_notaventa" action="{{url('notaventa/store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <label class="text-info">Seleccione al cliente: </label>
                                    <select class="form-control" required id="idcliente" name="idcliente">
                                ...
                                <div class="col-md-4">
                                    <label class="text-info">Descuento: </label>
                                    <input name="descuento" class="form-control" min="0" type="number" value="0" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                            ...
                            <div class="form-group row"  style="padding-right: 15px;">
                                <div class="col-md-12 col-sm-12">
                                    <button type="button" onclick="tratardeagregarnotaventa()" class="btn btn-primary">Guardar</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function tratardeagregarnotaventa(){
        $('#detalles_input').val(JSON.stringify(detalles));
        console.log($('#detalles_input').val());
        console.log(detalles);
        var form_notaventa = document.getElementById('form_notaventa');
        if (form_notaventa.checkValidity()) {
            $.ajax({
                type: "POST",
                url: "{{url('notaventa/store')}}",
                data: new FormData($("#form_notaventa")[0]),
                headers: {
